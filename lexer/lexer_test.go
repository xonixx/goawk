...
func TestLexer(t *testing.T) {
	tests := []struct {
		...
		{"1_234", `1:1 int "1_234"`},
		{"0X10", `1:1 int "0X10"`},
		{"0X_1_0", `1:1 int "0X_1_0"`},
		{"0xCaFeBABE", `1:1 int "0xCaFeBABE"`},
		{"0x10yy", `1:1 int "0x10", 1:5 name "yy"`},
		{"0xyy", `1:1 int "0", 1:2 name "xyy"`},
		//{"0x1p-2", `1:1 number "0x1p-2"`},
		//{"0x2.p10", `1:1 number "0x2.p10"`},
		//{"0x1.Fp+0", `1:1 number "0x1.Fp+0"`},
		//{"0X.8p-0", `1:1 number "0X.8p-0"`},
		//{"0X_1FFFP-16", ``},
		{"0x15e-2", `1:1 int "0x15e", 1:6 - "", 1:7 int "2"`},
		{"0x.", `1:1 int "0", 1:2 name "x", 1:4 <illegal> "expected digits"`},
		{"0X0..", `1:1 int "0X0", 1:5 <illegal> "expected digits"`},
		{".5", `1:1 number ".5"`},
		{".5e1", `1:1 number ".5e1"`},
		...
		{"0.", `1:1 number "0."`},
		{"1_5.", `1:1 number "1_5."`},
		{"1__2", `1:1 int "1", 1:2 name "__2"`}, // `1 __2`
		{"12_", `1:1 int "12", 1:3 name "_"`},   // `12 _`
